    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVideoCallBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String agent = "device/3.3.1 (Android" + android.os.Build.VERSION.SDK_INT + ";" + android.os.Build.BRAND + " " + android.os.Build.MODEL + ";" + Locale.getDefault().getLanguage() + "-" + Locale.getDefault().getCountry() + ")";
