...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toCalledUserId.setText("141281470500048896");
        ...
        //	larry_trtc_video_watch
        productIdEt.setText("8BW0MQZZU2");
        devNameEt.setText("test_device");
        devPskEt.setText("BvImpLnXT/ybJja+JUcPow==");
