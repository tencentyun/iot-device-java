...
import com.tencent.iot.explorer.device.rtc.ui.audiocall.audiolayout.Utils;
 ...
 */
public class BroadcastAudioLayoutManager extends RelativeLayout {
    ...
    public BroadcastAudioLayoutManager(Context context) {
        super(context);
        initView(context);
    }


    public BroadcastAudioLayoutManager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }


    public BroadcastAudioLayoutManager(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public BroadcastAudioLayout findAudioCallLayout(String userId) {
     ...
     * @return
     */
    public BroadcastAudioLayout allocAudioCallLayout(String userId) {
        if (userId == null) return null;
        if (mCount > MAX_USER) {
            return null;
        }
        ...
        layoutEntity.layout = new BroadcastAudioLayout(mContext);
    ...
    private TRTCLayoutEntity findEntity(BroadcastAudioLayout layout) {
        for (TRTCLayoutEntity entity : mLayoutEntityList) {
    ...
    private static class TRTCLayoutEntity {
        public BroadcastAudioLayout layout;
