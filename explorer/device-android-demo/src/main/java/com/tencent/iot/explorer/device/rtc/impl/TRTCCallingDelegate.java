...
public interface TRTCCallingDelegate {
     ...
     * 被邀请通话回调
     * @param sponsor 邀请者
     * @param trtc_userIdList 同时还被邀请的人
     * @param isFromGroup 是否IM群组邀请
     * @param callType 邀请类型 1-语音通话，2-视频通话
     */
    void onInvited(String sponsor, List<String> trtc_userIdList, boolean isFromGroup, int callType);

    /**
     * 正在IM群组通话时，如果其他与会者邀请他人，会收到此回调
     * 例如 A-B-C 正在IM群组中，A邀请[D、E]进入通话，B、C会收到[D、E]的回调
     * 如果此时 A 再邀请 F 进入群聊，那么B、C会收到[D、E、F]的回调
     * @param trtc_userIdList 邀请群组
     */
    void onGroupCallInviteeListUpdate(List<String> trtc_userIdList);
