...
public class WiFiActivity extends AppCompatActivity implements View.OnClickListener, NetWorkStateReceiver.NetworkStateReceiverListener {
    ...
    private boolean readyToConnectMqtt = false;
    private boolean readyToConnectWiFi = false;
...
//            // 5、连接目标WiFi成功，设备连接mqtt。
    ...
    private void createWifiHotspot() {
        ...
        // 1、设备创建WiFi热点。
        wiFiHostpotUtil.createWifiHotspot(WIFI_HOTSPOT_SSID, WIFI_HOTSPOT_PASSWORD, new WiFiHostpotUtil.CreateWifiHotspotCallback() {
            @Override
