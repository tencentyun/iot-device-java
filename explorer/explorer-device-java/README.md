...
下载[仓库](../..)下完整代码，IoT Explorer Java-SDK Demo示例代码在 [explorer-device-java](../explorer-device-java) 的module下。
...
示例中编辑 [IoTDataTemplate.java](src/main/java/com/tencent/iot/explorer/device/java/test/IoTDataTemplate.java) 文件中的参数配置信息
```
{
