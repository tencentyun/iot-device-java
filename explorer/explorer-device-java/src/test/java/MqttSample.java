...
//
            ...
            JSONArray arrFloat = new JSONArray();
            arrFloat.put(5.001);
            arrFloat.put(0.003);
            arrFloat.put(0.004);
            arrFloat.put(0.007);
            ...
            JSONArray arrStruct = new JSONArray();
    ...
    public static void main(String[] args) {
        ...
        // init connection
        System.out.println("mBrokerURL " + mBrokerURL);
        System.out.println("mProductID " + mProductID);
        System.out.println("mDevName " + mDevName);
        System.out.println("mDevPSK " + mDevPSK);
        System.out.println("mDevPriv " + mDevPriv);
