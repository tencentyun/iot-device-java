            ...
            if (type.equals(TYPE_BOOL)) { //BOOL类型取值0或者1
                ...
                if (value instanceof Float &&
                    ...
                    return Status.OK;
                        ...
                        ((Integer) value).doubleValue() >= Double.parseDouble(valueDescribeJson.getString("min")) &&
                        ((Integer) value).doubleValue() <= Double.parseDouble(valueDescribeJson.getString("max"))) {
                    return Status.OK;
                }
