            ...
            if (method.equals(METHOD_PROPERTY_CONTROL)){ //
                ...
                if (mTrtcCallBack != null) {
                    if (params.has("_sys_video_call_status")) {
                        ...
                        mTrtcCallBack.onGetCallStatusCallBack(callStatus, userid, username, TRTCCalling.TYPE_VIDEO_CALL);
                        ...
                        mTrtcCallBack.onGetCallStatusCallBack(callStatus, userid, username, TRTCCalling.TYPE_AUDIO_CALL);
                    }
                }
            }
