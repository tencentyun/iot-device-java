...
直连设备开发可参考`IoTLightFragment.java`和`LightSample.java`。

网关设备和子设备开发可参考`IoTGatewayFragment.java`、`GatewaySample.java`、`ProductLight.java`和`ProductAirconditioner.java`。