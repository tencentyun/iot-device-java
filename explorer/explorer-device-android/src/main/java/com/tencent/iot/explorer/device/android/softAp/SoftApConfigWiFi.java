...
public class SoftApConfigWiFi {
    ...
    private static final String protoVersion = "2.0";
    private Context mContext;

    public SoftApConfigWiFi(Context context, int PORT, TXMqttConnection connection) {
        this.PORT = PORT;
    ...
    private void getHost() {
        ...
        host = intToIp(wifiManager.getDhcpInfo().gateway);
//        host = intToIp(wifiManager.getDhcpInfo().ipAddress);
//        host = intToIp(wifiManager.getDhcpInfo().netmask);
//        host = intToIp(wifiManager.getDhcpInfo().dns1);
//        host = intToIp(wifiManager.getDhcpInfo().dns2);
//        host = intToIp(wifiManager.getDhcpInfo().serverAddress);
    }
     ...
     * int转化为ip地址
     */
    private String intToIp(Integer paramInt){
