...
public class MqttSampleTest {
    ...
    private void disconnect() {
        ...
        dataTemplateClient.disConnect(mqttRequest2);
    }
    ...
    private void eventSinglePost() {
        ...
        if(Status.OK != dataTemplateClient.eventSinglePost(eventId, type, params)){
            Log.e(TAG,"single event post failed!");
        }
    }
    ...
    public void testMqttConnect() {
        ...
        verify(mqttActionCallBack, timeout(2000).times(4)).onSubscribeCompleted(Matchers.eq(Status.OK), (IMqttToken) Mockito.any(), Mockito.any(), Mockito.anyString());
