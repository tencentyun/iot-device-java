...
public class VideoEncoder {
    ...
    private void initMediaCodec() {
        try {
            ...
            Log.i(LogConst.RTC_TAG, "videoCodec MediaCodec createEncoderByType video/avc");
            ...
            //开始编码
            mediaCodec.start();
            Log.i(LogConst.RTC_TAG, String.format("videoCodec start with MediaFormat Width %d * Height %d, bitRate: %d, color-format: YUV420SemiPlanar, frameRate: %d, i-frame-interval: %d, bitrate-mode: VBR",
        ...
        executor.submit(() -> {
            ...
            try {
                ...
                if (inputBufferIndex >= 0) {
                    ...
                    Log.i(LogConst.RTC_TAG, "video origin frame send to codec nv12 data with byte" + byte2HexOnlyLatest8(nv12) + "， seq: " + beforeSeq);
                ...
                while (outputBufferIndex >= 0) {
                    ...
                    if (bufferInfo.flags == MediaCodec.BUFFER_FLAG_KEY_FRAME) {
                        ...
                        if (encoderListener != null) {
                            Log.i(LogConst.RTC_TAG, "on video encoded i frame byte: "+byte2HexOnlyLatest8(dataBytes) + "; seq: " + seq);
...
//                        Log.e("TAG", "==========P帧===============" + seq);
                        if (encoderListener != null) {
                            Log.i(LogConst.RTC_TAG, "on video encoded p frame byte: "+byte2HexOnlyLatest8(outData) + "; seq: " + seq);
