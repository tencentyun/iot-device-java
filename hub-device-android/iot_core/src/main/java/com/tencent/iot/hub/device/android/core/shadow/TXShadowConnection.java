...
public class TXShadowConnection {
    ...
    public TXShadowConnection(Context context, String productID, String deviceName, String secretKey,
        ...
        this(context, TXMqttConstants.PREFIX + productID + QCLOUD_IOT_MQTT_DIRECT_DOMAIN + MQTT_SERVER_PORT_TLS, productID, deviceName, secretKey, bufferOpts, clientPersistence, callBack);
    }
