...
若用户在控制台上开启了自动创建设备，不需要在控制台预先创建设备，但需保证统一产品下没有重复的设备名称，一般可以取设备的唯一信息，比如mac地址，此种方式更加灵活。若用户在控制台上关闭了自动创建设备，则必须要预先创建设备，动态注册时的设备要与录入的设备名称一致，此种方式更加安全，但便利性有所下降。
