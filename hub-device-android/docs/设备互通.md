* [设备互通](#设备互通)
  ...
  * 3 [运行示例程序体验设备互通模块](#运行示例程序体验设备互通模块)
  * 4 [体验 Door 设备进门](#体验-Door-设备进门)
  * 5 [体验 Door 设备出门](#体验-Door-设备出门)
...
观察Logcat日志。
```
I/TXMQTT_1.3.0: Starting subscribe topic: XMN6AZ4M0Y/airConditioner1/control
...
I/iot.scenarized.Door: onConnectCompleted：connected to ssl://iotcloud-mqtt.gz.tencentdevices.com:8883
I/TXMQTT_1.3.0: Starting publish topic: 9RW4A8OOFK/door1/event Message: {"action": "come_home", "targetDevice": "airConditioner1"}
...
观察Logcat日志。
```
I/TXMQTT_1.3.0: Starting publish topic: 9RW4A8OOFK/door1/event Message: {"action": "leave_home", "targetDevice": "airConditioner1"}
I/iot.scenarized.Door: onDisconnectCompleted, status[OK], msg[disconnected to ssl://iotcloud-mqtt.gz.tencentdevices.com:8883]
I/TXMQTT_1.3.0: Received topic: XMN6AZ4M0Y/airConditioner1/control, id: 28, message: {"action":"leave_home","targetDevice":"airConditioner1"}
