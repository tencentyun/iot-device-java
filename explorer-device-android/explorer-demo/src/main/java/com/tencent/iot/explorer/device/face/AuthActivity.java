...
public class AuthActivity extends AppCompatActivity {
    ...
    private void connect() {
        mFaceKitSample = new FaceKitSample(getApplicationContext(), mBrokerURL, mProductID, mDevName, mDevPSK, new SelfMqttActionCallBack(), mJsonFileName, new SelfDownStreamCallBack());
        mFaceKitSample.connect();
    }
...
//                    mParent.printLogInfo(TAG, "Construct params failed!", mLogInfoText, TXLog.LEVEL_ERROR);
    ...
    private class SelfMqttActionCallBack extends TXMqttActionCallBack {
        ...
        public void onConnectCompleted(Status status, boolean reconnect, Object userContext, String msg) {
            ...
            Log.d(TAG, logInfo);
            if (!reconnect) {
                mFaceKitSample.subscribeServiceTopic();
                mFaceKitSample.initAuth(new TXAuthCallBack() {
                    @Override
                ...
                mFaceKitSample.checkResource(FACE_IMG_DIR);
            }
        }
