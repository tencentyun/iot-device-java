package com.tencent.iot.explorer.device.android.app.trtc.data_template;
...
import com.tencent.iot.explorer.device.trtc.data_template.TXTRTCTemplateClient;
...
public class TRTCDataTemplateSample {
     ...
     * MQTT连接实例
     */
    private TXTRTCTemplateClient mMqttConnection;
    ...
    TXTRTCCallBack mTrtcCallBack = null;

    public TRTCDataTemplateSample(Context context) {
        mContext = context;
    }

    public TRTCDataTemplateSample(Context context, String brokerURL, String productId, String devName, String devPSK, String devCertName, String devKeyName, TXMqttActionCallBack mqttActionCallBack,
    ...
    public TRTCDataTemplateSample(Context context, String brokerURL, String productId, String devName, String devPSK,TXMqttActionCallBack mqttActionCallBack,
                              final String jsonFileName, TXDataTemplateDownStreamCallBack downStreamCallBack, TXTRTCCallBack trtcCallBack) {
        mContext = context;
        mBrokerURL = brokerURL;
        mProductID = productId;
     ...
     */
    public void connect() {
        mMqttConnection = new TXTRTCTemplateClient( mContext, mBrokerURL, mProductID, mDevName, mDevPSK,null,null, mMqttActionCallBack,
                mJsonFileName, mDownStreamCallBack, mTrtcCallBack);
