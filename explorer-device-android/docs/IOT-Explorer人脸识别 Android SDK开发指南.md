...
如果不需要接入人脸识别离线SDK，仅需要接入iot_explorer SDK，请参考 [编译环境及SDK接入说明.md](#https://github.com/tencentyun/iot-device-java/edit/master/explorer-device-android/docs/编译环境及SDK接入说明.md)
