...
public class GattServerActivity extends Activity {
    ...
    private void startAdvertising() {
        ...
        AdvertiseData data = new AdvertiseData.Builder()
                .addServiceUuid(new ParcelUuid(IOTBLEProfile.IOT_BLE_SERVICE))
                .setIncludeDeviceName(true)
                .setIncludeTxPowerLevel(false)
                .addManufacturerData(0x5678, advertisingData())
                .build();
//        data.writeToParcel();
        ...
        public void onCharacteristicReadRequest(BluetoothDevice device, int requestId, int offset,
            ...
            if (IOTBLEProfile.IOT_BLE_DEVICE_INFO.equals(characteristic.getUuid())) {
                ...
                mBluetoothGattServer.sendResponse(device,
                        ...
                        0,
                        IOTBLEProfile.getExactTime(now, IOTBLEProfile.ADJUST_NONE));
