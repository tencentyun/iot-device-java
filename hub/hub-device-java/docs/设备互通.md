...
Door模型在SDK Demo示例中对应的是 [Door.java](https://github.com/tencentyun/iot-device-java/blob/master/hub/hub-device-java/src/main/java/com/tencent/iot/hub/device/java/main/scenarized/Door.java) 文件，需要填好该文件中对应的参数。
...
Airconditioner模型在SDK Demo示例中对应的是 [Airconditioner.java](https://github.com/tencentyun/iot-device-java/blob/master/hub/hub-device-java/src/main/java/com/tencent/iot/hub/device/java/main/scenarized/Airconditioner.java) 文件，需要填好该文件中对应的参数。
...
运行 [DeviceInterworkingApp.java](https://github.com/tencentyun/iot-device-java/blob/master/hub/hub-device-java/src/main/java/com/tencent/iot/hub/device/java/DeviceInterworkingApp.java) ，初始化Airconditioner，将 Airconditioner 进行 MQTT 认证连接，认证连接通过后就订阅自身 Topic `${productId}/${deviceName}/control`。示例代码如下：
