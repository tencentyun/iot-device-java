...
```
connectComplete
11/03/2021 19:47:17,509 [MQTT Call: DVSVXI409Ccert_test_1] DEBUG MqttSample onConnected 189  - onConnected CONNECTING
```
...
```
11/03/2021 19:48:17,509 [MQTT Call: DVSVXI409Ccert_test_1] DEBUG MqttSample onConnected 189  - disconnect onSuccess
```
