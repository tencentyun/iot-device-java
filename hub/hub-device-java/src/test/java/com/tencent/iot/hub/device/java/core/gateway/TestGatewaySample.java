...
//
	...
	@Test
	public void testGatewaySubdevOnline() {
		mUnitTest = true;
		LogManager.resetConfiguration();
		LOG.isDebugEnabled();
		PropertyConfigurator.configure(TestMqttSample.class.getResource("/log4j.properties"));
	...
	@Test
	public void testGatewaySubdevOffline() {
		mUnitTest = true;
		LogManager.resetConfiguration();
		LOG.isDebugEnabled();
		PropertyConfigurator.configure(TestMqttSample.class.getResource("/log4j.properties"));
	...
	@Test
	public void testGatewaySubDevBinded() {
		mUnitTest = true;
		LogManager.resetConfiguration();
		LOG.isDebugEnabled();
		PropertyConfigurator.configure(TestMqttSample.class.getResource("/log4j.properties"));
	...
	@Test
	public void testGatewaySubDevUnbinded() {
		mUnitTest = true;
		LogManager.resetConfiguration();
		LOG.isDebugEnabled();
		PropertyConfigurator.configure(TestMqttSample.class.getResource("/log4j.properties"));
	...
	@Test
	public void testGatewayCheckSubdevRelation() {
		mUnitTest = true;
		LogManager.resetConfiguration();
		LOG.isDebugEnabled();
		PropertyConfigurator.configure(TestMqttSample.class.getResource("/log4j.properties"));
