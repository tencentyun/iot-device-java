...
Door模型在SDK Demo示例中对应的是 [Door.java](https://github.com/tencentyun/iot-device-java/blob/master/hub/hub-device-android/hub-demo/src/main/java/com/tencent/iot/hub/device/android/app/scenarized/Door.java) 文件，需要填好该文件中对应的参数。
...
Airconditioner模型在SDK Demo示例中对应的是 [Airconditioner.java](https://github.com/tencentyun/iot-device-java/blob/master/hub/hub-device-android/hub-demo/src/main/java/com/tencent/iot/hub/device/android/app/scenarized/Airconditioner.java) 文件，需要填好该文件中对应的参数。
