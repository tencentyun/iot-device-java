...
Door模型在SDK Demo示例中对应的是 [Door.java](../../hub-android-demo/src/main/java/com/tencent/iot/hub/device/android/app/scenarized/Door.java) 文件，需要[app-config.json](../../hub-android-demo/app-config.json)填写对应的参数。
...
Airconditioner模型在SDK Demo示例中对应的是 [Airconditioner.java](../../hub-android-demo/src/main/java/com/tencent/iot/hub/device/android/app/scenarized/Airconditioner.java) 文件，需要[app-config.json](../../hub-android-demo/app-config.json)填写对应的参数。
